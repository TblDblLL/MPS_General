...
Процедура ПриЗаполненииВидовДоступа(ВидыДоступа) Экспорт  
	...
	ВидДоступа = ВидыДоступа.Добавить();
	ВидДоступа.Имя = "ГруппыДоступаНоменклатуры";
	ВидДоступа.Представление    = НСтр("ru = 'Группы доступа номенклатуры'");
	...
	ВидДоступа = ВидыДоступа.Добавить();
	ВидДоступа.Имя = "ГруппыДоступаКлиентов";
	ВидДоступа.Представление    = НСтр("ru = 'Группы доступа клиентов'");
	ВидДоступа.ТипЗначений      = Тип("СправочникСсылка.Клиенты");
	ВидДоступа.ТипГруппЗначений = Тип("СправочникСсылка.ГруппыДоступаКлиентов");
...
Процедура ПриЗаполненииИспользованияВидаДоступа(ВидДоступа, Использование) Экспорт
	...
	Если ВидДоступа = "ГруппыДоступаНоменклатуры" Тогда
		Использование = Константы.ИспользоватьГруппыДоступаНоменклатуры.Получить();
		
	ИначеЕсли ВидДоступа = "ГруппыДоступаКлиентов" Тогда
		Использование = Константы.ИспользоватьГруппыДоступаКлиентов.Получить();
...
Описание = Описание + "
    |Справочник.Клиенты.Чтение.ГруппыКлиентов
    |Справочник.Клиенты.Изменение.ГруппыКлиентов
