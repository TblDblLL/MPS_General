...
Процедура УстановитьДоступность(РеквизитПутьКДанным = "")
	...
	Если РеквизитПутьКДанным = "НаборКонстант.ИспользоватьГруппыДоступаКлиентов" ИЛИ РеквизитПутьКДанным = "" Тогда
		Элементы.ОткрытьГруппыДоступаКлиентов.Доступность = НаборКонстант.ИспользоватьГруппыДоступаКлиентов;
	...
	Если РеквизитПутьКДанным = "НаборКонстант.ОграничиватьДоступНаУровнеЗаписей" ИЛИ РеквизитПутьКДанным = "" Тогда
		...
		УстановитьДоступность("НаборКонстант.ИспользоватьГруппыДоступаКлиентов");
...
&НаКлиенте
Процедура ОткрытьГруппыДоступаКлиентов(Команда)
	//++ НЕ ГОСИС
	ОткрытьФорму("Справочник.ГруппыДоступаКлиентов.ФормаСписка", , ЭтаФорма);
	//-- НЕ ГОСИС
КонецПроцедуры

&НаКлиенте
Процедура ИспользоватьГруппыДоступаКлиентовПриИзменении(Элемент)
	Подключаемый_ПриИзмененииРеквизита(Элемент);
КонецПроцедуры
